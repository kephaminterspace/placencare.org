...
function process_form( $cf7 ) {
	...
	if( $cf7->id() == 20 ) {
		$hapikey = '4b69398d-f249-42d0-bbbc-bfc80cc6bb30';
	}elseif ($cf7->id() == 9){
		$hapikey = 'b41ef5a0-d0e5-4238-898e-024f86c72ae0';
	}else{
		$hapikey = 'b64e71f2-bcd2-499c-a0c9-ab0de4e82812';
	}
	$t=time();
	$arr = array(
		'properties' => array(
			...
			array(
				'property' => 'note',
				'value' => $posted_data['your-subject']
			),
			array(
				'property' => 'aff_source',
				'value' => $posted_data['aff_source']
			),
			array(
				'property' => 'aff_sid',
				'value' => $posted_data['aff_sid']
			),
			array(
				'property' => 'identifier',
